...
import com.tomiprasetyo.goodmart.databinding.ActivityProfileBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signOut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("Goodmart","logout");
                startActivity(intent);
                finish();
            }
        });
        ...
        binding.orderedProduct.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(ProfileActivity.this,OrderedProductActivity.class));
            }
        });
